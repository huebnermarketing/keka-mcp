...
export function registerAttendanceTools(server) {
    server.registerTool("keka_get_attendance", {
...
Examples:
  ...
  - Check if an employee was present → employeeIds='emp123', from='2025-03-10', to='2025-03-10'`,
        ...
        try {
            ...
            const res = await client.getPaginated("/time/attendance", queryParams);
            if (!res.succeeded) {
            ...
            const lines = [
                ...
                ...res.data.map((a) => {
                    ...
                    return (`| ${a.employeeName ?? a.employeeId} | ${a.date} | ${a.clockIn ?? "—"} | ` +
