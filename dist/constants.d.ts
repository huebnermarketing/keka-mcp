...
export declare const TOKEN_EXPIRY_BUFFER_SECONDS = 120;
/** Keka OAuth token endpoint base */
export declare const KEKA_AUTH_BASE = "https://login.keka.com";
/** Keka sandbox OAuth token endpoint base */
export declare const KEKA_AUTH_BASE_SANDBOX = "https://login.kekademo.com";
/** Keka API rate limit: requests per minute */
export declare const RATE_LIMIT_RPM = 50;
